...
# from first.log_ctrl import logger
...
# config_path = os.path.join(dir_path,'conf')
config_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),'conf')
config_name = 'config.ini'
# config_h = Adminconfig(config_path='C:\\Users\\gaoya\\Desktop\\py2021\\reptile_hamob\\conf\\',config_name=config_name)
config_h = Adminconfig(config_path=config_path)
config_h.reade_config()

# host = config_h.get_config('Redis','host')
# print(host)
# C:\Users\gaoya\Desktop\py2021\reptile_hamob\conf\config.ini